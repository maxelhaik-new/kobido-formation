...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#ffffff] text-[#101010] selection:bg-[#f5dae3] selection:text-[#101010]">
      ...
      <nav className="sticky top-0 z-50 w-full h-[53px] bg-white border-b border-black/[0.06] px-4 sm:px-8 flex items-center justify-between">
        <div className="flex items-center">
          <span className="font-serif text-[22px] font-bold text-[#101010] tracking-tight cursor-default">
            L&apos;art du Geste
          </span>
        </div>
        ...
        <div className="hidden sm:flex items-center gap-1 text-[13px] font-medium text-[#101010]">
          <span className="flex items-center gap-1.5 px-3 py-1.5 rounded-md hover:bg-black/[0.04] transition-colors cursor-default">
            <Home className="w-3.5 h-3.5 text-[#101010]" />
            <span>Accueil</span>
          </span>
          <span className="flex items-center gap-1.5 px-3 py-1.5 rounded-md hover:bg-black/[0.04] transition-colors cursor-default opacity-80">
            <Book className="w-3.5 h-3.5 text-[#101010]" />
            <span>Mes Modules</span>
          </span>
          <span className="flex items-center gap-1.5 px-3 py-1.5 rounded-md hover:bg-black/[0.04] transition-colors cursor-default opacity-80">
            <FileVideo className="w-3.5 h-3.5 text-[#101010]" />
        ...
        <div className="flex items-center">
          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#faf4f6] border border-[#f5dae3] text-[#b54e71] text-[11px] font-semibold tracking-wide">
      ...
      <div className="relative w-full h-[30vh] min-h-[220px] max-h-[340px] overflow-hidden bg-[#faf8f5]">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/images/cover.jpg"
          alt="L’Art du Geste"
          className="w-full h-full object-cover object-[center_65.4%]"
        />
      </div>

      {/* 3. Notion Content Flow Container */}
      <div className="w-full max-w-[900px] mx-auto px-5 sm:px-10 pt-8 pb-16 flex-1 flex flex-col">
        {/* Page Title (Identical to Super.so Notion H1) */}
        ...
        <div className="w-full max-w-[500px] mx-auto my-auto py-2">
          <div className="bg-white rounded-[11px] border border-[#f5dae3] p-7 sm:p-9 shadow-[rgba(0,0,0,0.1)_0px_20px_40px_-10px] transition-all">
            <div className="flex flex-col items-center text-center mb-6">
              ...
              <h2 className="font-serif text-2xl font-bold text-[#101010] tracking-tight">
                Bienvenue dans votre formation
              </h2>

              <p className="text-xs sm:text-[13px] text-[#555555] mt-2.5 leading-relaxed">
                Ce module e-learning présente les bases gestuelles du Kobido. Veuillez saisir votre mot de passe pour déverrouiller vos cours, vidéos et protocoles.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={isPending}
                className="w-full flex items-center justify-center gap-2 py-3.5 px-5 rounded-[11px] bg-[#b54e71] hover:bg-[#9f3e5e] active:bg-[#86314e] text-white font-semibold text-sm transition-all duration-200 shadow-[0_4px_14px_0_rgba(181,78,113,0.35)] hover:shadow-[0_6px_20px_rgba(181,78,113,0.45)] disabled:opacity-70 cursor-pointer disabled:cursor-not-allowed group"
              >
                {isPending ? (
                  <>
